...
export default function Footer({
    ...
    return (
        <section
            ref={footerRef}
            className="fixed bottom-0 left-0 right-0 z-0 border-t border-gray-200 w-full mx-auto  px-4 sm:px-6 lg:px-42 xl:px-24 2xl:px-6 max-w-[1100px] py-8 text-sm  bg-background text-muted-foreground">
