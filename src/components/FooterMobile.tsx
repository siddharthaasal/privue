...
export default function FooterMobile({
  ...
  return (
    <footer className="bg-background text-muted-foreground flex flex-col gap-10 border-t border-gray-200 px-6 py-10 text-sm">
      {/* Logo + Address */}
      <div className="flex flex-row items-start justify-between">
        ...
        <div className="text-foreground-lighter space-y-1 text-sm">
                ...
                <ul className="space-y-2">
                  {section.links.map((link, i) => (
                    <li key={i}>
                      <a
                        href={link.url}
                        className="text-foreground-lighter hover:text-foreground block text-sm font-normal transition-colors"
                      >
                        {link.text}
                      </a>
                    </li>
