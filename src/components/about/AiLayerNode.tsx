...
function AiLayerNodeInner({ data }: { data?: any }) {
    ...
    return (
        <div className="w-[260px] h-[200px] flex items-center justify-center relative box-border">
            {/* SVG module */}
            <svg
                width="240"
                height="160"
            ...
            <div className="absolute bottom-2 left-0 right-0 flex justify-center pointer-events-none">
                <div className="text-[15px] font-semibold text-slate-100 tracking-wide px-2 py-1 rounded-md bg-gradient-to-r from-indigo-600/70 to-blue-700/70 backdrop-blur-sm">
                    {label}
                </div>
            </div>
            ...
            <Handle
                ...
                id="left"
                className="!bg-slate-600 !w-2 !h-2 rounded-full border-0 top-1/2 -translate-y-1/2"
            />
            <Handle
                type="source"
            ...
            <Handle
                ...
                id="bottom"
                className="!bg-slate-600 !w-2 !h-2 rounded-full border-0 left-1/2 -translate-x-1/2"
            />
        </div>
    );
}
