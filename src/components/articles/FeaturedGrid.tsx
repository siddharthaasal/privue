...
export default function ArticleGrid() {
  return (
    <div className="mx-auto px-2">
      <div className="mx-auto grid h-auto w-full grid-cols-4 grid-rows-2 gap-4 py-8">
        {/* Row 1 */}
      ...
      <a
        href="/articles"
        className="font-open-sans group text-foreground-lighter col-span-full mx-auto flex cursor-pointer items-center justify-end gap-2 pb-32"
      >
        <span className="text-sm text-[#707070] transition-colors duration-200 group-hover:text-[#171717]">
          Explore all Articles
        </span>
        <ExternalLink
          className="text-lg text-[#707070] transition-colors duration-200 group-hover:text-[#171717]"
          size={14}
        />
      </a>
    </div>
