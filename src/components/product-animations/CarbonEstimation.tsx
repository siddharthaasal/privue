...
function BusinessSiteFrame() {
    ...
    return (
        ...
        >
            <div className="text-[12px] font-semibold text-slate-800 tracking-wide">
                BUSINESS <span className="font-bold">SITE</span>
            </div>
            <div className="text-[10.5px] text-slate-600 mt-1 mb-3">
                        ...
                        <div key={r.id} className="grid grid-cols-[90px_1fr_90px] items-center gap-2">
                            ...
                            <div className="relative flex items-center gap-2">
                                ...
                                <input
                                    ...
                                    value={displayValue}
                                    readOnly
                                    className="w-full px-2 py-1 rounded border border-slate-200 text-[11px] text-slate-800 bg-white"
                                ...
                                <select
                                    className="text-[10px] border border-slate-200 rounded px-2 py-1 bg-white text-slate-700"
...
function EmissionsFrame() {
    return (
        ...
        >
            ...
            <div className="grid grid-cols-[1fr_70px_70px_50px] text-[11px] font-medium text-slate-600 border-b border-slate-100 pb-1 mb-1">
                <div></div>
            ...
            {data.map((section, si) => (
                <div key={si} className="mb-1">
                    <motion.div
                        ...
                        className="text-[9.5px] text-slate-500 font-medium mb-[2px]"
                    >
                        {section.scope}
                    </motion.div>
                    ...
                    {section.rows.map((r, ri) => (
                        <motion.div
                            key={ri}
                            variants={rowVariants}
                            className="grid grid-cols-[1fr_70px_70px_50px] items-center text-[11px] py-[2px]"
                        >
                    ...
                    <motion.div
                        variants={rowVariants}
                        className="grid grid-cols-[1fr_70px_70px_50px] items-center text-[11px] font-semibold border-t border-slate-100 pt-[2px] mt-[2px]"
                    >
            ...
            <motion.div
                variants={rowVariants}
                className="grid grid-cols-[1fr_70px_70px_50px] items-center text-[12px] font-semibold border-t border-slate-200 pt-1 mt-1"
            >
...
function EmissionsWaterfallFrame() {
    ...
    return (
        ...
        >
            <div className="text-[11px] font-semibold text-slate-900 mb-2">Total emission per waterfall</div>
            ...
            <div className="mt-2 flex items-center gap-3 text-[10px] text-slate-600">
                <div className="flex items-center gap-1">
                    <span className="inline-block w-3 h-3 rounded-sm" style={{ background: COLORS.baseline }} />
                    <span>FY totals</span>
                </div>
                <div className="flex items-center gap-1">
                    <span className="inline-block w-3 h-3 rounded-sm" style={{ background: COLORS.positive }} />
