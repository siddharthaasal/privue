  ...
  const series: Series[] = [
    {
      name: 'Flood',
      color: '#2563eb',
      values: [0.06, 0.1, 0.15, 0.22, 0.3, 0.38, 0.47, 0.56, 0.65, 0.73, 0.8],
    },
    {
      name: 'Drought',
      color: '#f59e0b',
      values: [0.05, 0.08, 0.06, 0.09, 0.12, 0.1, 0.15, 0.18, 0.14, 0.19, 0.22],
    },
    {
      name: 'Heatwave',
      color: '#ef4444',
      values: [0.09, 0.12, 0.18, 0.26, 0.35, 0.44, 0.52, 0.6, 0.68, 0.75, 0.82],
    },
    {
      name: 'Cyclone',
      color: '#7c3aed',
      values: [0.05, 0.06, 0.08, 0.09, 0.1, 0.11, 0.12, 0.13, 0.14, 0.14, 0.15],
    },
    {
      name: 'Coastal Inundation',
      color: '#2dd4bf',
      values: [0.12, 0.16, 0.21, 0.27, 0.35, 0.43, 0.52, 0.61, 0.69, 0.75, 0.8],
    },
    {
      name: 'Water Scarcity',
      color: '#f97316',
      values: [0.03, 0.05, 0.07, 0.1, 0.14, 0.19, 0.25, 0.3, 0.35, 0.4, 0.45],
    },
  ];
