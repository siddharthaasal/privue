                ...
                <table className="w-full text-xs">
                    <thead className="bg-slate-50 text-slate-600 sticky top-0">
                        <tr>
                            ...
                            <th className="text-left px-3 py-3 text-[11px]">State</th>
...
const dealerRowsInitial = [
    ...
    { name: "Nova Distributors", gst: "06NVDST2222Y8ZX", mobile: "+91 91234 00001", state: "Haryana" },
    { name: "Prime Hardware", gst: "24PRMHW3333A1BB", mobile: "+91 92345 67890", state: "Gujarat" },
    { name: "Alpha Traders", gst: "09ALPHT4444C2CC", mobile: "+91 93456 78901", state: "Uttar Pradesh" },
    ...
    { name: "Lakeside Components", gst: "32LAKSC9999H7HH", mobile: "+91 98901 23456", state: "Kerala" },
    { name: "Horizon Export", gst: "36HRZNX0000J8JJ", mobile: "+91 99012 34567", state: "Telangana" },
    { name: "Crest Technologies", gst: "23CRSTT1111K9KK", mobile: "+91 90123 45678", state: "Madhya Pradesh" },
