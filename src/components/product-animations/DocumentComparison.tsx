...
function Frame3ExcelPreview() {
    ...
    return (
        ...
        >
            <h3 className="text-xs font-sm mb-2 text-gray-700">
                Excel Preview
            </h3>

            <div className="border border-gray-300 overflow-hidden text-[10px] leading-[14px]">
                <table className="w-full border-collapse">
                    <thead>
                        <tr className="bg-[#E2EAFB] text-gray-800 font-semibold border-b border-gray-300">
                            <th className="px-2 py-1 border-r border-gray-300">Item</th>
                            <th className="px-2 py-1 border-r border-gray-300">Amount</th>
...
remains elongated due to higher inventory holding.`;
    ...
    return (
        <motion.div
            ...
            animate={{ opacity: 1, scale: 1 }}
        >
            <h3 className="text-xs mb-3 text-gray-700">
                PDF Preview
            </h3>
            ...
            <div className="flex gap-3 items-start self-start">
                ...
                {/* Fake PDF Page */}
                <div className="w-20 h-28 bg-white border border-gray-300 rounded-sm shadow-sm relative overflow-hidden p-[6px]">
                    <div className="space-y-[3px]">
                        {Array.from({ length: 10 }).map((_, i) => (
                            <div
                                key={i}
                                className="h-[3px] bg-gray-200 rounded"
                                style={{ width: `${60 + (i % 3) * 10}%` }}
                            ></div>
                        ))}
                    </div>

                    <span className="absolute bottom-1 right-1 text-[8px] text-gray-400">
                        1
                    </span>
                </div>
                ...
                {/* Extracted Text */}
                <p
                    className="text-xs text-gray-600 leading-snug whitespace-pre-line 
               max-w-[220px] overflow-hidden line-clamp-[7]"
                >
                    {dummyPdfText}
                </p>
...
export function Frame5ComparisonTable() {
    return (
        <motion.div
            className="max-h-[280px] w-[375px] md:w-[500px] origin-bottom-right scale-[0.75] overflow-y-auto 
                 rounded-lg bg-white/95 p-4 shadow-sm backdrop-blur-sm sm:scale-[0.9] 
                 md:max-h-[280px] md:max-w-[540px] md:scale-100 md:p-3"
            initial="hidden"
            animate="show"
            ...
            <div className="overflow-hidden border border-gray-300">
                <table className="w-full text-[11px]">
                    ...
                    <thead className="bg-gray-100 text-gray-700 font-medium">
                        <tr>
                            <th className="py-1.5 px-2 text-left border-r border-gray-300 w-[130px]">
                                Category
                            </th>
                            <th className="py-1.5 px-2 text-left border-r border-gray-300 w-[110px]">
                                Excel
                            </th>
                            <th className="py-1.5 px-2 text-left border-r border-gray-300 w-[110px]">
                                Document
                    ...
                    <motion.tbody variants={parentVariants}>
                        {tableData.map((row, idx) => (
                            ...
                            >
                                ...
                                <td className="py-1 px-2 border-r border-gray-200 font-mono text-[10px] text-blue-700">
                                    {row.excel}
                                </td>

                                <td className="py-1 px-2 border-r border-gray-200 font-mono text-[10px] text-purple-700">
                                    {row.doc}
                                </td>

                                <td className="py-1 px-2 text-gray-600 leading-tight">
                                    {row.remarks}
                                </td>
                            </motion.tr>
                        ))}
...
export default function DocumentComparison() {
    ...
    const labels = ['Analyzing file structure', 'Extracting data', 'Processing content', 'Generating preview'];
