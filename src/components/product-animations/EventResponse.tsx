...
export default function EventResponse({
  bgUrl = '/module-animations/event-response-bg.png',
  ...
  return (
    <div className="relative h-full w-full overflow-hidden rounded-lg">
      ...
      <div
        aria-hidden
        className="absolute inset-0 rounded-2xl border border-gray-100 bg-cover bg-center bg-no-repeat object-cover"
        style={{
