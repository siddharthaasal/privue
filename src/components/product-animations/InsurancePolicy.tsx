                ...
                <div className="space-y-2 max-w-[420px] w-full">
                    <div className="rounded-md bg-white/98 p-3 w-full border border-slate-200/50">
                        <div className="text-left mb-2">
                            ...
                            <div className="text-[10px] text-slate-500 mt-0.5">Drag or drop your insurance policy here or click to upload</div>
                        </div>
                            ...
                            <div className="relative w-full max-w-[320px] flex items-center justify-center">
                                ...
                                >
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="text-[11.5px] font-medium text-slate-900 truncate">insurance_policy.pdf</div>
...
const rows = [
    ...
    { key: "super-structure", label: "Super Structure Building Plinth and Foundation", value: "₹ 61,07,48,892" },
...
export function PolicyOverviewCompact() {
    return (
        <motion.div
            ...
            className="rounded-md bg-white/95 backdrop-blur-sm p-2 w-[380px] max-h-[320px] overflow-auto border border-slate-100"
        ...
        >
            ...
            <motion.div initial="hidden" animate="show" variants={containerVariants} className="divide-y divide-slate-100">
                {rows.map((r) => {
                    const isSectionHeader = r.value === "" && (r.label.endsWith("Breakdown") || r.label.endsWith("Information"));
                    return (
                        <motion.div
                            key={r.key}
                        ...
                        >
                            <div className={`text-[10px] ${isSectionHeader ? "font-medium text-slate-700" : "text-[10px] text-slate-800"}`}>
                                {r.label}
                            </div>
...
export function DeductiblesCompactStaggered() {
    ...
    return (
        <motion.div
            ...
            className="rounded-md bg-white/96 border border-slate-100 p-2 w-[420px] h-auto overflow-hidden"
        ...
        >
            <div className="flex items-center justify-between mb-1 px-1">
                ...
                <div className="flex items-center gap-2">
                    <span className="inline-flex items-center px-2 py-0.5 rounded-md bg-amber-50 text-amber-700 text-[9px] font-medium">
                        Standard Excess
                    </span>

                    <button
                        aria-label="More info"
                        className="w-6 h-6 flex items-center justify-center rounded hover:bg-slate-50"
                        title="Information"
                    >
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" aria-hidden>
                            <path d="M12 11v2" stroke="#6b7280" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round" />
                            <path d="M12 7h.01" stroke="#6b7280" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round" />
            ...
            <motion.div
                ...
                initial="hidden"
                animate="show"
                className="text-[9.5px] text-slate-700 leading-snug px-1"
            >
                {lines.map((ln, i) => (
                    ...
                    <motion.div
                        ...
                        className="overflow-hidden mb-1 last:mb-0"
...
function InfoIcon({ size = 14 }: { size?: number }) {
    return (
        <svg width={size} height={size} viewBox="0 0 24 24" fill="none" aria-hidden>
            ...
            <path d="M12 11v4" stroke="#6b7280" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M12 8h.01" stroke="#6b7280" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
    );
}
...
export function ExclusionsCompact() {
    return (
        <motion.div
            ...
            className="rounded-md bg-white/96 border border-slate-100 p-2 w-[420px] max-w-full"
            aria-live="polite"
            ...
            >
                {items.map((it) => (
                    <motion.li
                        ...
                        className="flex items-start gap-3 bg-white rounded-sm border border-slate-50 px-3 py-2"
                    >
                        ...
                        <div className="min-w-0">
                            <div className="text-[10px] font-medium text-slate-800 leading-tight truncate">{it.title}</div>
