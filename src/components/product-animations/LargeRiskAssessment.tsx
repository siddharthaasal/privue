          ...
          >
            ...
            <motion.div className="flex flex-col items-start space-y-1.5" variants={item}>
              ...
              >
                <Badge
                  variant="secondary"
                  className="border border-amber-200 bg-amber-50 px-1.5 py-0.5 text-[10px] text-amber-700"
                >
                  Fair
                </Badge>
              </motion.div>
            ...
            <motion.div className="flex flex-col" variants={item}>
              <span className="text-muted-foreground text-[10px] uppercase">Months Delinquent</span>
              <span className="text-[11px] font-medium">6</span>
            </motion.div>

            <motion.div className="flex flex-col" variants={item}>
              <span className="text-muted-foreground text-[10px] uppercase">
                Max Delinquency (months)
              </span>
              <span className="text-[11px] font-medium">42</span>
            </motion.div>
            ...
            <motion.div className="col-span-2 flex flex-col" variants={item}>
              ...
              <span className="text-[11px] font-medium">62 months</span>
            </motion.div>
          </motion.div>
        </CardContent>
      </Card>
...
function FinancialSnapshotCard() {
  ...
  const data = [
    ...
    { label: 'Working Capital Turnover Ratio', value: '2.81' },
...
function ContributoryFactorsCard() {
  const leftItems = [
    'Liquidity coverage and turnover poor​',
    'Dramatic increase in debt in the last 3 years​',
    '5 months delinquent in last 6 Months',
...
function RiskSignalsCard() {
  const rightItems = [
    'Highly volatile commodity prices of inputs',
    'Macro-economic headwinds due to US Tariffs​',
    'Multiple court cases and compliance flags​',
    'GST filings delays​',
  ];
...
export default function LargeRiskAssessment() {
