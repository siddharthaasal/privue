...
import { Scale, BanknoteArrowUp, ScanText, Bot, DatabaseZap, FolderGit2, Newspaper, FileChartPie } from 'lucide-react';
...
export default function EntityDueDiligenceWorkflow({ className, style, fitPadding = 0.06 }: Props) {
