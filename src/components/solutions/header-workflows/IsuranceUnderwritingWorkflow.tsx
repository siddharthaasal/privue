...
import InsuranceUnderwritingChatNode from "./chat-nodes/InsuranceUnderwritingChatNode";
...
import { ScanText, Bot, DatabaseZap, Newspaper, FolderGit2, Scale, GitPullRequestCreateArrow } from 'lucide-react';
...
const initialNodes: Node[] = [
    ...
    },
    {
        ...
        position: { x: 80, y: 180 },
        data: {
            label: "Underwriting Platform",
            icon: "/privue-logo.png",
        },
    },
    {
        id: "ocr",
...
const nodeTypes = {
    ...
    chatNode: InsuranceUnderwritingChatNode,
};
...
export default function InsuranceUnderwritingWorkflow({ className, style, fitPadding = 0.06 }: Props) {
