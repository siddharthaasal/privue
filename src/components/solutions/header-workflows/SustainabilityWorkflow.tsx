...
import SustainabilityChatNode from "./chat-nodes/SustainabilityChatNode";
...
import { ScanText, Bot, DatabaseZap, Factory, MonitorSpeaker, CloudRain } from 'lucide-react';
...
const initialNodes: Node[] = [
    ...
    },
    {
        ...
        position: { x: 80, y: 180 },
        data: {
            label: "CMIP 6 and IMD",
            // icon: "/icons/workflow/cmip-logo.png",
            icon: "/icons/workflow/cmip-icon.svg",
        },
    },
    {
        id: "ocr",
...
const nodeTypes = {
    ...
    chatNode: SustainabilityChatNode,
};
...
export default function SustainabilityWorkflow({ className, style, fitPadding = 0.06 }: Props) {
