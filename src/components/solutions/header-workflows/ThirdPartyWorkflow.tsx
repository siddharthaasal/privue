...
import { Scale, BanknoteArrowUp, ScanText, Bot, DatabaseZap, FolderGit2, Newspaper, ShieldAlert } from 'lucide-react';
...
export default function ThirdPartyWorkflow({ className, style, fitPadding = 0.06 }: Props) {
