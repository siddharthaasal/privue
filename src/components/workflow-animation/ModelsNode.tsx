...
function ModelsNodeInner({ data }: { data: ModelsNodeData }) {
  ...
  if (animation === 'vertical') {
    ...
    return (
      <div
        className="border-privue-900 rounded-lg border"
        ...
        <div style={{ width: '100%', overflow: 'hidden' }}>
          <div
            style={{
              ...
              transition: 'transform 560ms cubic-bezier(.22,.9,.34,1)',
              width: extended.length * (itemWidth + 12),
            }}
          >
            {extended.map((m, idx) => (
              <div
              ...
              >
                <div style={{ display: 'flex', gap: 12, alignItems: 'center' }}>
                  ...
                  >
                    {m.icon === 'db' && (
                      <DbIconDummy size={18} className="text-[var(--privue-900,#0f1724)]" />
                    )}
                    {m.icon === 'file' && (
                      <FileText size={18} className="text-[var(--privue-900,#0f1724)]" />
                    )}
                    {m.icon === 'cloud' && (
                      <Cloud size={18} className="text-[var(--privue-900,#0f1724)]" />
                    )}
                  </div>
                  ...
                  >
                    <div
                      style={{ fontSize: 13, fontWeight: 700, color: 'var(--privue-900,#0f1724)' }}
                    >
                      {m.title}
                    </div>
            ...
            >
              ...
              >
                <div style={{ display: 'flex', gap: 12, alignItems: 'center' }}>
                  ...
                  <div
                    style={{ fontSize: 15, fontWeight: 700, color: 'var(--privue-900,#0f1724)' }}
                  >
                    {m.title}
                  </div>
                </div>
