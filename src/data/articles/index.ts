...
export const loaders: Record<string, () => Promise<any>> = {
  'strengthening-insolvency-investigations': () =>
    import('/src/data/articles/strengthening-insolvency-investigations.mdx'),
  'redefining-commercial-lines-underwriting': () =>
    import('/src/data/articles/redefining-commercial-lines-underwriting.mdx'),
  'optimizing-distributor-credit-risk-management': () =>
    import('/src/data/articles/optimizing-distributor-credit-risk-management.mdx'),
  'mitigating-risk-in-global-supplier-selection': () =>
    import('/src/data/articles/mitigating-risk in-global-supplier-selection.mdx'),
  'transforming-credit-risk-assessment': () =>
    import('/src/data/articles/transforming-credit-risk-assessment.mdx'),
  'enhancing-supply-chain-resilience': () =>
    import('/src/data/articles/enhancing-supply-chain-resilience.mdx'),
};
