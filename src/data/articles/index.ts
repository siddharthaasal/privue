...
export const loaders: Record<string, () => Promise<any>> = {
  'strengthening-insolvency-investigations': () =>
    import('./strengthening-insolvency-investigations.mdx'),
  'redefining-commercial-lines-underwriting': () =>
    import('./redefining-commercial-lines-underwriting.mdx'),
  'optimising-distributor-credit-management': () =>
    import('./optimising-distributor-credit-management.mdx'),
  'mitigating-risk-in-global-supplier-selection': () =>
    import('./mitigating-risk in-global-supplier-selection.mdx'),
