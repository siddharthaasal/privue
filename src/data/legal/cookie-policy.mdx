...
- **Manage Preferences Anytime:** [https://YOURDOMAIN/COOKIE-PREFERENCES]
- **Do Not Sell or Share My Personal Information (CPRA):** [https://YOURDOMAIN/DO-NOT-SELL-OR-SHARE]
...
- **CPRA Status:** These may constitute “sale” or “sharing” for cross-context behavioural advertising.
...
- **Withdraw Consent:** Change settings anytime at [https://YOURDOMAIN/COOKIE-PREFERENCES]
- **Browser Controls:** You can block or delete cookies in your browser settings (site functionality may be affected).
- **Global Privacy Control (GPC):** We honour GPC signals for relevant processing (e.g., sale/share under CPRA).
- **Do Not Sell/Share (CPRA):** If advertising cookies are used, exercise rights at [https://YOURDOMAIN/DO-NOT-SELL-OR-SHARE].
