...
## Cookie Table (Example — Replace with Actual Setup)  

> **Note to Devs:** Populate with your real inventory. Keep categories aligned with the toggles in your CMP.  

### Strictly Necessary  
- **Name:** `__Secure-session`  
  - **Provider:** PRIVUE  
  - **Purpose:** Maintains logged-in session, prevents CSRF  
  - **Type:** First-party  
  - **Duration:** Session  

- **Name:** `consent-state`  
  - **Provider:** PRIVUE  
  - **Purpose:** Stores consent choices  
  - **Type:** First-party  
  - **Duration:** 12 months  

### Performance & Analytics  
- **Name:** `fp_analytics_id`  
  - **Provider:** PRIVUE  
...
- **Name:** `locale_pref`  
  - **Provider:** PRIVUE  
  - **Purpose:** Remembers language/region  
  - **Type:** First-party  
  - **Duration:** 12 months  

### Advertising & Targeting  
- **Name:** `ad_id / _fbp / _fbc`  
  - **Provider:** [Ad Platform Name]  
  - **Purpose:** Ad delivery/measurement  
  - **Type:** Third-party  
  - **Duration:** Up to 24 months  
  - **CPRA:** May be sale/share  
  - **Provider Policy:** [Link]  

### Social Media  
- **Name:** `social_plugin_id`  
  - **Provider:** [Platform Name]  
  - **Purpose:** Social plug-in  
  - **Type:** Third-party  
  - **Duration:** [X months]  
  - **Provider Policy:** [Link]  
