...
import CreditMemoReviewShowcase from '@/components/product-animations/CreditMemoReview';
import DocumentComparison from '@/components/product-animations/DocumentComparison';
import InternalAuditWorkflow from '@/components/solutions/header-workflows/InternalAuditWorkflow';
import EarlyWarningIndicatorsDemo from '@/components/product-animations/EarlyWarningIndicators';
...
export const solutions: Solution[] = [
  ...
  },
  {
    ...
    icon: '/icons/solutions/distributor-performance-management.png',
    img: '/workflow/third-party-workflow.jpg',
    workflow: InternalAuditWorkflow,
    coverImg: '/solutions/demo-image.png',
    ...
    problems: [
      ...
      },
      {
        ...
        problemDesc: 'Limited visibility into emerging risk areas reduces audit effectiveness.',
      },
    ],
    solnPoints: [
      {
    ...
    modules: [
      ...
      },
      {
        ...
        description: '',
        imgSrc: '/demo-module-image.png',
        renderAnimation: DocumentComparison,
        link: '#',
      },
      {
        ...
        description: '',
        imgSrc: '/demo-module-image.png',
        renderAnimation: CreditMemoReviewShowcase,
        link: '#',
      },
      {
        ...
        description: '',
        imgSrc: '/demo-module-image.png',
        renderAnimation: EarlyWarningIndicatorsDemo,
        link: '#',
      },
      {
        title: 'Conversational AI',
