  ...
  return (
    <section className="relative min-h-screen bg-gradient-to-b from-white via-white to-gray-50 dark:from-gray-950 dark:via-gray-950 dark:to-gray-900">
      ...
      <div className="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
        <div className="bg-primary/20 dark:bg-primary/25 absolute -top-40 left-1/2 h-72 w-[36rem] -translate-x-1/2 rounded-full blur-3xl" />
      </div>
      ...
      <div className="mx-auto flex max-w-3xl flex-col items-center px-6 py-20 text-center md:py-28 lg:py-32">
        ...
        >
          ...
          {/* 404 headline */}
          <h1 className="from-primary to-primary/60 bg-gradient-to-br bg-clip-text text-7xl font-extrabold tracking-tight text-transparent md:text-8xl lg:text-9xl">
            404
          </h1>

          <p className="mt-6 text-2xl font-semibold text-balance text-gray-900 md:text-3xl dark:text-gray-100">
            Something’s missing.
          </p>
          <p className="mt-3 max-w-xl text-base text-pretty text-gray-600 dark:text-gray-400">
          ...
          >
            ...
            >
              ...
              <g fill="none" stroke="currentColor" strokeWidth="2" className="text-primary">
                <path
                  d="M10 150 C 80 120, 140 180, 200 150 S 320 120, 390 150"
                  stroke="url(#grad)"
                />
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
            <Link
              to="/"
              className="bg-primary focus-visible:ring-primary/40 dark:shadow-primary/10 inline-flex items-center gap-2 rounded-2xl px-5 py-3 text-sm font-semibold text-white shadow-sm transition-transform hover:scale-[1.02] hover:shadow-md focus-visible:ring-2 focus-visible:outline-none active:scale-[0.98]"
            >
