...
export default function ContactPage() {
  return (
    <Layout>
      <main className="mx-auto px-4 sm:px-6 md:min-h-screen lg:px-8">
        {/* Mobile-first: single column; preserve 2-col layout on md+ (laptop and up) */}
        <div className="grid grid-cols-1 gap-x-6 gap-y-8 px-4 pt-12 md:grid-cols-2 md:gap-x-24 md:px-12 md:pt-24">
          <div>
            <ContactHero />
          </div>
          <div>
