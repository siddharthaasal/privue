            ...
            <div className="dark">
                <section className="-mt-32 relative flex min-h-screen items-center justify-center rounded-lg p-6 md:p-20 dark:bg-[#121212]">
                    ...
                    <div className="relative flex flex-col items-center justify-center text-center gap-4 h-full">
                        ...
                        >
                            <Announcement className="bg-gray-800">
                        ...
                        >
                            <div className="text-center">
                                ...
                                <h1 className="text-[clamp(2rem,4vw,3.5rem)] font-medium tracking-tight font-open-sans text-black dark:text-foreground-dark">
                        ...
                        <motion.p
                            ...
                            className="text-lg text-neutral-700 font-medium font-open-sans max-w-2xl dark:text-foreground-lighter-dark"
                        >
                        ...
                        >
                            ...
                            <Button variant="outline" size="default">
                                <a href="/articles" className="font-open-sans shadow-text-md text-white">Case Studies</a>
                            </Button>
                        </motion.div>
                    </div>
